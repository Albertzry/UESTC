    ...
    def _inference(self, seri_vec, init_lstm_cell, init_lstm_hidden, only_inference=False):
        ...
        with tf.variable_scope("hero_main"):
            ...
            for index in range(len(hero_main)):
                ...
                fc1_hero_weight = self._fc_weight_variable(shape=[vec_fc1_input_dim, 256], name="fc1_hero_main_weight")
                fc1_hero_bias = self._bias_variable(shape=[256], name="fc1_hero_main_bias")
                fc1_hero_result = tf.nn.relu((tf.matmul(hero_main[index], fc1_hero_weight) + fc1_hero_bias),
                                            name="fc1_hero_main_result_%d" % index)

                fc2_hero_weight = self._fc_weight_variable(shape=[256, 128], name="fc2_hero_main_weight")
                fc2_hero_bias = self._bias_variable(shape=[128], name="fc2_hero_main_bias")
                fc2_hero_result = tf.nn.relu((tf.matmul(fc1_hero_result, fc2_hero_weight) + fc2_hero_bias),
                                            name="fc2_hero_main_result_%d" % index)

                fc3_hero_weight = self._fc_weight_variable(shape=[128, 64], name="fc3_hero_main_weight")
                fc3_hero_bias = self._bias_variable(shape=[64], name="fc3_hero_main_bias")
                fc3_hero_result = tf.nn.relu((tf.matmul(fc2_hero_result, fc3_hero_weight) + fc3_hero_bias),
                                            name="fc3_hero_main_result_%d" % index)

                fc4_hero_weight = self._fc_weight_variable(shape=[64, 32], name="fc4_hero_main_weight")
                fc4_hero_bias = self._bias_variable(shape=[32], name="fc4_hero_main_bias")
                fc4_hero_result = tf.nn.relu((tf.matmul(fc3_hero_result, fc4_hero_weight) + fc4_hero_bias),
                                            name="fc4_hero_main_result_%d" % index)

                fc5_hero_weight = self._fc_weight_variable(shape=[32, 16], name="fc5_hero_main_weight")
                fc5_hero_bias = self._bias_variable(shape=[16], name="fc5_hero_main_bias")
                fc5_hero_result = tf.add(tf.matmul(fc4_hero_result, fc5_hero_weight), fc5_hero_bias,
                                        name="fc5_hero_main_result_%d" % index)

            hero_main_concat_result = fc5_hero_result
        ...
        with tf.variable_scope("fc1_value"):
            fc1_value_weight = self._fc_weight_variable(shape=[self.lstm_unit_size, 128], name="fc1_value_weight")
            fc1_value_bias = self._bias_variable(shape=[128], name="fc1_value_bias")
        ...
        with tf.variable_scope("fc2_value"):
            fc2_value_weight = self._fc_weight_variable(shape=[128, 1], name="fc2_value_weight")
